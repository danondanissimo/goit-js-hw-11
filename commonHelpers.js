...
<li class="image-stats-item">
  ...
  </div></li>`).join("")}const d=new c(".gallery a",{captionsData:"alt",captionDelay:250});function p(s){if(n.replaceChildren(),s.hits.length===0)m.show({message:"Sorry, there are no images matching your search query. Please try again!",closeOnClick:!0,closeOnEscape:!0});else{const t=g(s);n.insertAdjacentHTML("afterbegin",t),d.refresh()}}
