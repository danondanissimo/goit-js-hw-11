...
<li class="image-stats-item">
  ...
  </div></li>`).join("")}const g=new c(".gallery a",{captionsData:"alt",captionDelay:250});o.addEventListener("load",()=>{n.style.display="none"});function p(s){if(s.hits.length===0)m.show({message:"Sorry, there are no images matching your search query. Please try again!",closeOnClick:!0,closeOnEscape:!0});else{const t=f(s);o.insertAdjacentHTML("afterbegin",t),g.refresh()}}
